...
i2s_chan_handle_t AudioEs7210::es7210_i2s_init(void)
{
    ...
    i2s_tdm_config_t i2s_tdm_rx_conf = {
        ...
        .gpio_cfg = {
            ...
            .dout = GPIO_NUM_NC, // ES7210 does not use this pin
            .din = EXAMPLE_I2S_DI_IO,
        },
    };

    if (channel_num == 2) {
        i2s_tdm_rx_conf.slot_cfg = I2S_TDM_PHILIPS_SLOT_DEFAULT_CONFIG(EXAMPLE_I2S_SAMPLE_BITS, 
            I2S_SLOT_MODE_STEREO, EXAMPLE_I2S_TDM_SLOT_MASK);
    }
    else if (channel_num == 1)
    {
        i2s_tdm_rx_conf.slot_cfg = I2S_TDM_PHILIPS_SLOT_DEFAULT_CONFIG(EXAMPLE_I2S_SAMPLE_BITS,
             I2S_SLOT_MODE_MONO, (i2s_tdm_slot_mask_t)(I2S_TDM_SLOT0));
    }
